...
- Merge p-values from ATAC & RNA.

- Use IMIX for integrative analysis.
...
# 6. Run IMIX for ATAC-RNA Integration

Run IMIX for integration and retrieve significant genes with FDR control.
